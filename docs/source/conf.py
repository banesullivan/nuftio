...
latex_documents = [
    (master_doc, 'nuftio.tex', 'nuftio Documentation',
...
man_pages = [
    (master_doc, 'nuftio', 'nuftio Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nuftio', 'nuftio Documentation',
     author, 'nuftio', 'One line description of project.',
     'Miscellaneous'),
]
